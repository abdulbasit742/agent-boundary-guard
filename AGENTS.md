...
These instructions apply to the entire `abdulbasit742/agent-boundary-guard` repository. More specific AGENTS.md or AGENTS.override.md files in subdirectories may refine them.

Project: **Agent Boundary Guard**.
